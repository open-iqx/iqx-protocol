...
#   - ``<agent-id>.key``            — node credential, named after the resolved
#     agent id (see ``iqx.examples.identity.key_path_for``). Pinning the id
#     keeps the same credential across restarts; a generated id mints a new one.
